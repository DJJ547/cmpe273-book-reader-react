    ...
    <>
      ...
      <div className="hidden md:flex relative bg-mycolor2">
        <nav className="z-20 flex shrink-0 grow-0 justify-around gap-4 p-2.5 fixed top-2/4 -translate-y-2/4 right-[420px] flex-col rounded-lg">
          <a className="flex aspect-square w-16 items-center justify-center rounded-md shadow-md bg-mycolor2 hover:scale-110 active:scale-95 cursor-pointer transition-transform">
            <svg
      ...
      <div className="md:hidden fixed z-20">
        <nav
          ...
          ref={bottomBarRef}
        >
          <a className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center rounded-md hover:bg-gray-100 dark:bg-sky-900 dark:text-sky-50">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
